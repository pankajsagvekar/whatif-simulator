...
class FunOutcomeGenerator {
     ...
     */
    async generateFunOutcome(scenario) {
        ...
        try {
            ...
            if (error instanceof ErrorHandler_1.WhatIfSimulatorError && !error.retryable) {
                return ErrorHandler_1.ErrorHandler.createFallbackContent('fun', scenario.originalText, error.message);
            }
            ...
            return ErrorHandler_1.ErrorHandler.createFallbackContent('fun', scenario.originalText, fallbackReason);
        }
    }
    /**
     ...
     */
    formatFunResponse(response, scenario) {
     ...
     */
    enhanceCreativeFormatting(text) {
        let formatted = text;
...
exports.FunOutcomeGenerator = FunOutcomeGenerator;
//# sourceMappingURL=FunOutcomeGenerator.js.map