...
export const personalScenarios: TestScenario[] = [
  {
...
export const professionalScenarios: TestScenario[] = [
  {
...
export const historicalScenarios: TestScenario[] = [
  {
...
export const hypotheticalScenarios: TestScenario[] = [
  {
...
export const appropriatenessTestScenarios: TestScenario[] = [
  {
...
export const allTestScenarioSets: TestScenarioSet[] = [
  { name: 'Personal Scenarios', scenarios: personalScenarios },
  { name: 'Professional Scenarios', scenarios: professionalScenarios },
  { name: 'Historical Scenarios', scenarios: historicalScenarios },
  { name: 'Hypothetical Scenarios', scenarios: hypotheticalScenarios },
  { name: 'Complex Scenarios', scenarios: complexScenarios },
  { name: 'Edge Case Scenarios', scenarios: edgeCaseScenarios },
  { name: 'Appropriateness Test Scenarios', scenarios: appropriatenessTestScenarios },
  { name: 'Performance Test Scenarios', scenarios: performanceTestScenarios }
];

// Utility functions for test data
export function getScenariosByType(type: 'personal' | 'professional' | 'historical' | 'hypothetical'): TestScenario[] {
  return allTestScenarioSets
    .flatMap(set => set.scenarios)
    .filter(scenario => scenario.expectedType === type);
}

export function getScenariosByComplexity(complexity: 'simple' | 'moderate' | 'complex'): TestScenario[] {
  return allTestScenarioSets
    .flatMap(set => set.scenarios)
...
export function getAllScenarios(): TestScenario[] {
  return allTestScenarioSets.flatMap(set => set.scenarios);
}

export function getRandomScenarios(count: number): TestScenario[] {
  const allScenarios = getAllScenarios();
  const shuffled = [...allScenarios].sort(() => Math.random() - 0.5);
  return shuffled.slice(0, count);
}

export function getScenarioInputs(scenarios: TestScenario[]): string[] {
